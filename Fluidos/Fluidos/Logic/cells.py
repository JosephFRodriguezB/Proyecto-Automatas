...
class LiquidCell:
    def __init__(self, color="Blanco", scale=(0,0)):
        # Constructor: define los atributos iniciales del objeto
        self.color = color  # Atributo de instancia
        self.scale = scale  # Atributo de instancia
...
class Cell:
    ...
    def Update(self):
        ...
        # Ajusta el tamaño del Liquid según la capacidad de la cell
